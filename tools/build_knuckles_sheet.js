// Builds web/js/knuckles_sheet.js (the sheet format described in
// web/js/character.js, as an embedded PNG data URL) from the Sonic Chaos style
// Knuckles sheet by PixelMarioXP:
//   node tools/build_knuckles_sheet.js [source.png] [out.js | out.png]
...
const out = process.argv[3] || path.join(root, 'web/js/knuckles_sheet.js');
const CELL = 40;
...
const png = encodePng(W, CELL, dst);
if (out.endsWith('.png')) fs.writeFileSync(out, png);
else fs.writeFileSync(out, '// Generated by tools/build_knuckles_sheet.js from art/knuckles_chaos_pixelmarioxp.png\n' +
  '// (Knuckles sprites by PixelMarioXP).  Do not edit.\n' +
  "(typeof window !== 'undefined' ? window : globalThis).SC.KNUCKLES_SHEET =\n  'data:image/png;base64," + png.toString('base64') + "';\n");
